...
namespace ninaAPI.WebService
{
    ...
    public static class CommonErrors
    {
        ...
        public static HttpException ParameterOutOfRange(string parameter, double min, double max) => new(HttpStatusCode.BadRequest, $"Parameter {parameter} is out of range, expected {min} - {max}");
